...
final class MainActivityKt$OnboardingScreen$6$1$1$2$2 implements Function4<LazyItemScope, Integer, Composer, Integer, Unit> {
    ...
    final /* synthetic */ List<AiProvider> $providers;
    final /* synthetic */ MutableState<Boolean> $showProviderPicker$delegate;

    /* JADX WARN: Multi-variable type inference failed */
    MainActivityKt$OnboardingScreen$6$1$1$2$2(List<AiProvider> list, String str, Function1<? super AiProvider, Unit> function1, Function1<? super String, Unit> function12, MutableState<Boolean> mutableState) {
        this.$providers = list;
    ...
    public final void invoke(LazyItemScope lazyItemScope, int i, Composer composer, int i2) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(862054318, i2, -1, "com.hermes.android.OnboardingScreen.<anonymous>.<anonymous>.<anonymous>.<anonymous>.<anonymous> (MainActivity.kt:1042)");
        }
        final AiProvider aiProvider = this.$providers.get(i);
        boolean zAreEqual = Intrinsics.areEqual(aiProvider.getId(), this.$apiProvider);
        composer.startReplaceGroup(91913927);
        ...
        if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = new Function0() { // from class: com.hermes.android.MainActivityKt$OnboardingScreen$6$1$1$2$2$$ExternalSyntheticLambda0
                public final Object invoke() {
                    return MainActivityKt$OnboardingScreen$6$1$1$2$2.invoke$lambda$1$lambda$0(aiProvider, function1, function12, mutableState);
                }
            };
