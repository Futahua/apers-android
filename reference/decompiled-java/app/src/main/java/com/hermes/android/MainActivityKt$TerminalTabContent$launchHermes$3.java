...
@DebugMetadata(c = "com.hermes.android.MainActivityKt$TerminalTabContent$launchHermes$3", f = "MainActivity.kt", i = {}, l = {4252}, m = "invokeSuspend", n = {}, s = {})
final class MainActivityKt$TerminalTabContent$launchHermes$3 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    MainActivityKt$TerminalTabContent$launchHermes$3(AppCompatActivity appCompatActivity, TerminalView terminalView, TerminalSessionManager terminalSessionManager, BootstrapManager bootstrapManager, MutableState<Boolean> mutableState, MutableState<Boolean> mutableState2, MutableIntState mutableIntState, MutableState<Boolean> mutableState3, MutableState<Boolean> mutableState4, MutableState<Boolean> mutableState5, AtomicReference<Function2<TerminalSession, Uri, Unit>> atomicReference, MutableIntState mutableIntState2, Continuation<? super MainActivityKt$TerminalTabContent$launchHermes$3> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        try {
            if (i == 0) {
                ...
                this.label = 1;
                obj = BuildersKt.withContext(Dispatchers.getIO(), new MainActivityKt$TerminalTabContent$launchHermes$3$ok$1(this.$bootstrapManager, null), (Continuation) this);
        ...
        MainActivityKt.TerminalTabContent$installScrollAwareCallback(mutableState, mutableState2, mutableState3, atomicReference, terminalView, simpleTerminalClient, new Function0() { // from class: com.hermes.android.MainActivityKt$TerminalTabContent$launchHermes$3$$ExternalSyntheticLambda0
            public final Object invoke() {
                return MainActivityKt$TerminalTabContent$launchHermes$3.invokeSuspend$lambda$0(mutableIntState);
            }
        });
        ...
        terminalView2.post(new Runnable() { // from class: com.hermes.android.MainActivityKt$TerminalTabContent$launchHermes$3$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                MainActivityKt$TerminalTabContent$launchHermes$3.invokeSuspend$lambda$1(terminalView2);
            }
        });
