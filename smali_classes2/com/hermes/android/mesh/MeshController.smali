...
.method public final refreshKnownPeers(Ljava/util/List;)I
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :try_start_0
    iget-object v2, p0, Lcom/hermes/android/mesh/MeshController;->crypto:Lcom/hermes/android/handoff/HandoffCrypto;

    invoke-virtual {v2, v1}, Lcom/hermes/android/handoff/HandoffCrypto;->parseQr(Ljava/lang/String;)Lcom/hermes/android/handoff/HandoffCrypto$PeerInfo;
    ...
    iget-object v3, p0, Lcom/hermes/android/mesh/MeshController;->peers:Lcom/hermes/android/handoff/HandoffPeerStore;

    invoke-virtual {v3, v2}, Lcom/hermes/android/handoff/HandoffPeerStore;->get(Ljava/lang/String;)Lcom/hermes/android/handoff/HandoffCrypto$PeerInfo;

    move-result-object v2

    if-eqz v2, :goto_0

    invoke-virtual {p0, v1}, Lcom/hermes/android/mesh/MeshController;->pairFromQr(Ljava/lang/String;)Lcom/hermes/android/handoff/HandoffCrypto$PeerInfo;
