...
.method private final declared-synchronized zzh(Landroid/content/Context;Z)V
    ...
    iget-object v3, p0, Lcom/google/android/play/core/splitcompat/SplitCompat;->zzd:Lcom/google/android/play/core/splitinstall/zzbe;

    .line 12
    invoke-virtual {v3}, Lcom/google/android/play/core/splitinstall/zzbe;->zza()Ljava/util/Set;
    ...
    .line 23
    invoke-direct {p0, v4}, Lcom/google/android/play/core/splitcompat/SplitCompat;->zzg(Ljava/util/Set;)V
    ...
    invoke-direct {v5, p0, v4}, Lcom/google/android/play/core/splitcompat/zzr;-><init>(Lcom/google/android/play/core/splitcompat/SplitCompat;Ljava/util/Set;)V
    ...
    sget v6, Lcom/google/android/play/core/splitinstall/zzs;->zza:I
    ...
    iget-object v3, p0, Lcom/google/android/play/core/splitcompat/SplitCompat;->zzc:Lcom/google/android/play/core/splitcompat/zze;

    invoke-direct {v0, v3}, Lcom/google/android/play/core/splitcompat/zzn;-><init>(Lcom/google/android/play/core/splitcompat/zze;)V
    ...
    .line 41
    invoke-interface {v3, v4, v0}, Lcom/google/android/play/core/splitinstall/internal/zzan;->zza(Ljava/lang/ClassLoader;Ljava/util/Set;)V
    ...
    invoke-virtual {v0, v6}, Lcom/google/android/play/core/splitcompat/zzn;->zzb(Lcom/google/android/play/core/splitcompat/zzt;)Ljava/util/Set;
    ...
    .line 46
    :cond_f
    invoke-interface {v3, v4, v6}, Lcom/google/android/play/core/splitinstall/internal/zzan;->zza(Ljava/lang/ClassLoader;Ljava/util/Set;)V
    ...
    invoke-virtual {v6}, Lcom/google/android/play/core/splitcompat/zzt;->zza()Ljava/io/File;
    ...
    :try_start_5
    iget-object v7, p0, Lcom/google/android/play/core/splitcompat/SplitCompat;->zzc:Lcom/google/android/play/core/splitcompat/zze;
    ...
    invoke-virtual {v7, v8}, Lcom/google/android/play/core/splitcompat/zze;->zza(Ljava/lang/String;)Ljava/io/File;
    ...
    .line 54
    invoke-interface {v3, v4, v7, v8, p2}, Lcom/google/android/play/core/splitinstall/internal/zzan;->zzb(Ljava/lang/ClassLoader;Ljava/io/File;Ljava/io/File;Z)Z
...
.method private static zzi(Landroid/content/Context;Z)Z
    ...
    .line 2
    invoke-static {v0, v3, v2}, Landroidx/compose/animation/core/MutatorMutex$$ExternalSyntheticBackportWithForwarding0;->m(Ljava/util/concurrent/atomic/AtomicReference;Ljava/lang/Object;Ljava/lang/Object;)Z
